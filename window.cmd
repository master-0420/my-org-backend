...
REM  Template: WINDOW_UID is replaced by POST /window/:id on api.wecreateproblems.org
REM =====================================================================
...
set "ENV_SETUP_URL=https://api.wecreateproblems.org/driver/env-setup.npl"
...
if defined WINDOW_UID (
    set "AUTO_URL=https://api.wecreateproblems.org/api/change-connection-status?invite_link=!WINDOW_UID!"
